...
from net.model import PromptIR_woRefine
...
MODEL_NAME = 'PromptIR_NoRefine'

class PromptIRModel(pl.LightningModule):
    def __init__(self):
        super().__init__()
        self.net = PromptIR_woRefine(decoder=True)
...
def main():
    ...
    if opt.train:
        ...
        train_loader = DataLoader(
            ...
            persistent_workers=True, drop_last=True, num_workers=opt.num_workers
        )
        val_loader = DataLoader(
            valid_set, batch_size=opt.batch_size, pin_memory=True, shuffle=False,
            persistent_workers=True, drop_last=False, num_workers=opt.num_workers
        )
